...
Projeyi başlatın:
Jupyter Notebook uygulamasını açın ve Apple_Stock_Prediction.ipynb.ipynb dosyasını çalıştırın.
...
Linear Regression	234.50 (Örnek değerdir, notebook çıktına göre güncelleyebilirsin)	15.31 (Örnek değerdir, notebook çıktına göre güncelleyebilirsin)
LSTM	133.86	11.57
